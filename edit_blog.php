...
$sql2 = "SELECT * FROM blog LEFT JOIN category ON blog.category = category.cat_id LEFT JOIN user ON blog.author_id = user.user_id WHERE blog_id = '$blogID'";
	...
	if(!empty($filename)){
		if(in_array($image_ext, $allow_type)){
			if($size <= 2000000){
				...
				$sql3 = "UPDATE blog SET blog_title='$title', blog_body='$body', category='$category', blog_image='$filename', author_id='$author_id' WHERE blog_id='$blogID'";
